...
cat vendor_boot/dtb/04_dtbdump_Qualcomm_Technologies,_Inc._CliffsP_SoC.dtb.* 2>/dev/null >> vendor_boot/dtb/04_dtbdump_Qualcomm_Technologies,_Inc._CliffsP_SoC.dtb
rm -f vendor_boot/dtb/04_dtbdump_Qualcomm_Technologies,_Inc._CliffsP_SoC.dtb.* 2>/dev/null
...
cat odm/lib64/libvpnr_enroll_pad.so.* 2>/dev/null >> odm/lib64/libvpnr_enroll_pad.so
rm -f odm/lib64/libvpnr_enroll_pad.so.* 2>/dev/null
...
cat product/priv-app/MIUIMusicGlobalPad/MIUIMusicGlobalPad.apk.* 2>/dev/null >> product/priv-app/MIUIMusicGlobalPad/MIUIMusicGlobalPad.apk
rm -f product/priv-app/MIUIMusicGlobalPad/MIUIMusicGlobalPad.apk.* 2>/dev/null
...
cat mi_ext/product/data-app/Creation/Creation.apk.* 2>/dev/null >> mi_ext/product/data-app/Creation/Creation.apk
rm -f mi_ext/product/data-app/Creation/Creation.apk.* 2>/dev/null
